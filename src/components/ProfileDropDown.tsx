    ...
    <>
      ...
      >
        <div className='mt-1 end-0 absolute w-44 z-50 transition-all duration-300 bg-white shadow-lg border rounded-lg py-2 border-gray-200 dark:border-gray-700 dark:bg-gray-800'>
          <h6 className='flex items-center py-2 px-3 text-xs text-gray-800 dark:text-gray-400'>Bem vindo!</h6>
          ...
          <button
            ...
            className='flex w-full items-center gap-2 py-1.5 px-4 text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300'
          >
