              ...
              <div className='card overflow-hidden'>
                ...
                <div className='px-6 py-10'>
                  <div className='text-center'>
                    ...
                    <h4 className='text-danger text-lg uppercase my-7'>Nenhuma página localizada</h4>
                    <p>
                      Parece que você pegou o caminho errado. Não se preocupe... isso acontece com os melhores de nós.
                      Aqui está uma pequena dica que pode ajudá-lo a voltar aos trilhos.
                    </p>
                    <Link type='button' className='btn bg-info text-white mt-10' to='/'>
                      <i className='ri-home-4-line me-2'></i> Voltar para o Início
                    </Link>
                  </div>
                </div>
              </div>
